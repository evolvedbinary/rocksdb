...
public class ColumnFamilyTestCritical {
    ...
    public void openWithColumnFamilies() throws RocksDBException {
        ...
        try (final DBOptions options = new DBOptions()
            ...
            db.putCritical("dfkey1".getBytes(), "dfvalue".getBytes());
            db.putCritical(columnFamilyHandleList.get(0), "dfkey2".getBytes(), "dfvalue".getBytes());
    ...
    public void defaultColumnFamilySynonyms() throws RocksDBException {
        try (final Options options = new Options().setCreateIfMissing(true);
             final RocksDB db = RocksDB.open(options, dbFolder.getRoot().getAbsolutePath())) {
            db.putCritical("dfkey_syn_1".getBytes(), "dfvalue_syn_1".getBytes());
        }
    ...
    public void getWithOutValueAndCfPartial() throws RocksDBException {
        ...
        try (final DBOptions options =
            ...
            db.putCritical(columnFamilyHandleList.get(0), "key1".getBytes(), "value".getBytes());
            db.putCritical("key2".getBytes(), "12345678".getBytes());
    ...
    public void createWriteDropColumnFamily() throws RocksDBException {
        ...
        try (final DBOptions options = new DBOptions()
            ...
            db.putCritical(tmpColumnFamilyHandle, "key".getBytes(), "value".getBytes());
    ...
    public void createWriteDropColumnFamilies() throws RocksDBException {
        ...
        try (final DBOptions options = new DBOptions()
            ...
            db.putCritical(tmpColumnFamilyHandle, "key".getBytes(), "value".getBytes());
            db.putCritical(tmpColumnFamilyHandle2, "key".getBytes(), "value".getBytes());
        ...
        try (final DBOptions options = new DBOptions()
            ...
            .setCreateMissingColumnFamilies(true);
             final RocksDB db = RocksDB.open(options,
                 dbFolder.getRoot().getAbsolutePath(),
                 cfDescriptors, columnFamilyHandleList)) {
            db.putCritical(columnFamilyHandleList.get(1), "newcfkey".getBytes(), "value".getBytes());
            db.putCritical(columnFamilyHandleList.get(1), "newcfkey2".getBytes(), "value2".getBytes());
        ...
        try (final DBOptions options = new DBOptions()
            ...
            .setCreateMissingColumnFamilies(true);
             final RocksDB db = RocksDB.open(options,
                 dbFolder.getRoot().getAbsolutePath(),
                 cfDescriptors, columnFamilyHandleList)) {
            db.putCritical(columnFamilyHandleList.get(0), "key".getBytes(), "value".getBytes());
            db.putCritical(columnFamilyHandleList.get(1), "newcfkey".getBytes(), "value".getBytes());
    ...
    public void failPutDisposedCF() throws RocksDBException {
        ...
        try (final DBOptions options = new DBOptions()
            ...
            db.putCritical(columnFamilyHandleList.get(1), "key".getBytes(), "value".getBytes());
        }
    }
