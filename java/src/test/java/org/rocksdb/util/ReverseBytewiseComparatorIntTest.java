...
public class ReverseBytewiseComparatorIntTest {
  ...
  static Stream<Arguments> parameters() {
    return Stream.of(
        ...
        Arguments.of("direct_reused64_adaptive-mutex", true, 64, ReusedSynchronisationType.MUTEX ),
        ...
        Arguments.of("non-direct_reused64_adaptive-mutex", false, 64, ReusedSynchronisationType.THREAD_LOCAL ),
        Arguments.of("direct_reused64_adaptive-mutex", true, 64, ReusedSynchronisationType.THREAD_LOCAL ),
