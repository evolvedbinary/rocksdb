...
For instance, this is how to install the OSX jar you just built for 9.10.0

```bash
$ mvn install:install-file -Dfile=./java/target/rocksdbjni-9.10.0-osx.jar -DgroupId=org.rocksdb -DartifactId=rocksdbjni -Dversion=9.10.0-SNAPSHOT -Dpackaging=jar
```
